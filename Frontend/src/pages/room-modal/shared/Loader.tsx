...
const StyledWrapper = styled.div`
  ...
  .banter-loader__box:nth-of-type(3n) {
    margin-right: 0;
    margin-bottom: 6px;
  }

  .banter-loader__box:nth-of-type(1):before,
  .banter-loader__box:nth-of-type(4):before {
    margin-left: 26px;
  }

  .banter-loader__box:nth-of-type(3):before {
    margin-top: 52px;
  }

  .banter-loader__box:last-of-type {
    margin-bottom: 0;
  }
