  ...
  return (
    <div className="relative w-full h-full" ref={containerRef}>
      {showDetailView ? (
        ...
        .card svg polygon[data-id="1"],
        .card svg polygon[data-id="2"],
        .card svg polygon[data-id="3"],
        .card svg polygon[data-id="4"],
        .card svg polygon[data-id="5"],
        .card svg polygon[data-id="6"],
        .card svg polygon[data-id="7"],
        .card svg polygon[data-id="8"],
        .card svg polygon[data-id="9"],
        .card svg polygon[data-id="10"],
        .card svg polygon[data-id="11"],
        .card svg polygon[data-id="12"],
        .card svg polygon[data-id="13"],
        .card svg polygon[data-id="14"],
        .card svg polygon[data-id="15"],
        .card svg polygon[data-id="16"],
        .card svg polygon[data-id="17"],
        .card svg polygon[data-id="18"],
        .card svg polygon[data-id="19"],
        .card svg polygon[data-id="20"],
        .card svg polygon[data-id="21"],
        .card svg polygon[data-id="22"],
        .card svg polygon[data-id="23"],
        .card svg polygon[data-id="24"],
        .card svg polygon[data-id="25"],
        .card svg polygon[data-id="26"],
        .card svg polygon[data-id="27"],
        .card svg polygon[data-id="28"]{cursor:pointer}
      `}</style>
