describe("예매 플로우 E2E 테스트", function () {
    beforeEach(function () {
        // 테스트 실행 전 초기화
        cy.visit("/");
    });
    it("방 생성 후 예매하기 버튼 클릭까지 테스트", function () {
        // 로그인 상태 확인 및 로그아웃 처리
        cy.get("body").then(function ($body) {
            // 로그아웃 버튼이 있으면 로그인된 상태
            var logoutButton = $body
                .find("button")
                .filter(function (i, el) { var _a; return (_a = el.textContent) === null || _a === void 0 ? void 0 : _a.includes("로그아웃"); });
        ...
        // 현재 시간에서 2분 뒤 계산
        var now = new Date();
        var twoMinutesLater = new Date(now.getTime() + 2 * 60 * 1000);
        var hours = String(twoMinutesLater.getHours()).padStart(2, "0");
        var minutes = String(twoMinutesLater.getMinutes()).padStart(2, "0");
        ...
        cy.get(".MuiInputBase-input, input[type='text']")
            ...
            return (input.value === "" ||
                ...
                ((_a = input.getAttribute("aria-label")) === null || _a === void 0 ? void 0 : _a.includes("시간")) ||
                ((_d = (_c = (_b = input.parentElement) === null || _b === void 0 ? void 0 : _b.parentElement) === null || _c === void 0 ? void 0 : _c.textContent) === null || _d === void 0 ? void 0 : _d.includes("경기 시작")));
        })
            .first()
            .click({ force: true });
        ...
        cy.get("body").then(function ($body) {
            ...
            var timePickerOpen = $body.find('[role="dialog"]').length > 0 ||
                $body.find(".MuiPickersPopper-root").length > 0 ||
                $body
                    .find(".MuiPaper-root")
                    .filter(function (i, el) {
                    var _a, _b, _c;
                    return ((_a = el.textContent) === null || _a === void 0 ? void 0 : _a.includes("시간")) ||
                        ((_b = el.textContent) === null || _b === void 0 ? void 0 : _b.includes("시")) ||
                        ((_c = el.textContent) === null || _c === void 0 ? void 0 : _c.includes("분"));
                }).length > 0;
            if (timePickerOpen) {
        ...
        cy.url().then(function (url) {
            var roomIdMatch = url.match(/\/i-ticket\/(\d+)/);
        ...
        cy.get("@roomId").then(function (roomId) {
            // roomId로 예매 페이지로 이동
            cy.visit("/i-ticket/".concat(roomId), { timeout: 10000 });
            // 방 나가기 버튼 클릭
